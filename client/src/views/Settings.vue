  ...
  <div class="Settings">
    ...
    <div v-for="cat in cats" :key="cat.id">
      ...
      <div>
        ...
        <span><input v-model="cat.age" :id="'Age'+cat.id" required type="numeric" min="0" max="30" /></span>
      </div>
    ...
    <div>
      ...
      <div>
        ...
        <span><input v-model="newcat.age" id="Age" required type="numeric" min="0" max="30" /></span>
      </div>
